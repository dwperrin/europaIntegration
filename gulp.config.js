module.exports = function() {
    ...
    var config = {
        ...
        gitBuildParameters: '--git-dir="./build/.git" --work-tree="./build"',
        html: client + '**/*.html',
        htmltemplates: clientApp + '**/*.html',
        images: client + 'content/img/**/*.*',
        ...
        testlibraries: [
            ...
            nodeModules + '/mongoose/index.js',
            nodeModules + '/mocha-mongoose.js',
        ...
        serverUnitTests: [server + 'tests/unit/**/*.js'],
        serverIntergrationTests: [server + 'tests/intergration/**/*.js'],
